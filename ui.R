...
shinyUI(pageWithSidebar(
  ...
  # Visualise selection and results
  mainPanel(
    h3("Sample Mean Test ( H0:mua=mu0 | Ha:mua>mu0 )"),
    p("Power is the probability to reject the null hypothesis if the alternative is true, calibrated for a given alpha (type 1 error rate). This is the area under the blue curve on the right hand side of the vertical black line. Power is:"),
